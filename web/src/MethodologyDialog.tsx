      ...
      <div className="relative z-10 max-h-[85vh] w-full max-w-2xl overflow-auto rounded-2xl border border-edge bg-surface-2 shadow-2xl">
        ...
        <div className="px-6 py-5">
          ...
          <Block title="Azqato — growth + technical entry" dot>
            ...
            <strong className="text-slate-100">passes</strong> when it clears at least 7 of the 9. Revenue growth, EPS
            growth, P/E, and PEG use forward analyst-consensus estimates (next-fiscal-year revenue, next-12-month EPS,
            forward P/E, and PEG = forward P/E &divide; forward EPS growth); margins are trailing-twelve-month.
          </Block>
